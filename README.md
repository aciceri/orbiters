...
| [`projects/website`](projects/website) | letsrebase.com — the public site: the Orbiters community page, the pages the product signs itself with, and the signup form. Static pages, deliberately no framework. | HTML · CSS · Vite |
| [`projects/hub`](projects/hub/README.md) | The Orbiters hub, at letsrebase.com/hub — the freelancer and company signup wizards, and the admin area that reads them. | Python · FastAPI · SQLAlchemy · PostgreSQL · React · Vite |

"""The server half of the rebase signup conversion: OpenAI's Conversions API.
...
from rebase_core.http import HTTP_TIMEOUT_SECONDS, NETWORK_ERROR_STATUS, HttpCall, urllib_call
...
class ConversionsPixel:
    ...
    def send(
        ...
        *,
        ...
        `rebase conversions-check` uses to tell the owner whether the key works
